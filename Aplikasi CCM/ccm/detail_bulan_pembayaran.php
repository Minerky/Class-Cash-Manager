            ...
            <tbody>
              ...
              <?php foreach ($uang_kas as $duk): ?>
                ...
                <?php else: ?>
                  ...
                  <div class="modal fade" id="editMingguKe1<?= $duk['id_uang_kas']; ?>" tabindex="-1" role="diaimg" aria-labelledby="editMingguKe1Label<?= $duk['id_uang_kas']; ?>" aria-hidden="true">
                    <div class="modal-diaimg" role="document">
                      <form method="post">
                  ...
                  <div class="modal fade" id="editMingguKe2<?= $duk['id_uang_kas']; ?>" tabindex="-1" role="diaimg" aria-labelledby="editMingguKe2Label<?= $duk['id_uang_kas']; ?>" aria-hidden="true">
                    <div class="modal-diaimg" role="document">
                      <form method="post">
                        <input type="hidden" name="id_uang_kas" value="<?= $duk['id_uang_kas']; ?>">
                        <div class="modal-content">
...
<?php endif ?>
  ...
  <strong>Copyright &copy; 2024 Cash Class Manager.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Created By :</b> Rezky, Dilan, Aldyan
    </div>
  </footer>
